...
module TLXbar_2(
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[30], auto_in_a_bits_address[12]} == 2'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{45,65}]
  wire        requestAIO_0_1 = {~(auto_in_a_bits_address[30]), auto_in_a_bits_address[12]} == 2'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
  wire [18:0] _GEN = auto_in_a_bits_address[30:12] ^ 19'h40001;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_2 = {_GEN[18], _GEN[0]} == 2'h0;	// @[Arbiter.scala:88:30, Parameters.scala:137:{31,45,65}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch & (|readys_valid))	// @[Arbiter.scala:28:{18,27}, :90:24, Cat.scala:33:92]
        readys_mask <= _readys_mask_T_3 | {_readys_mask_T_3[0], 2'h0};	// @[Arbiter.scala:24:23, :88:30, package.scala:245:{43,53}]
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
