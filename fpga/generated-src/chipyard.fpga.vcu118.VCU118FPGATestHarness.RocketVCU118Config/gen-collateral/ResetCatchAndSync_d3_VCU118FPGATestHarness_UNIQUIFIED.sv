...
module ResetCatchAndSync_d3_VCU118FPGATestHarness_UNIQUIFIED(
  input  clock,
         reset,
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_VCU118FPGATestHarness_UNIQUIFIED io_sync_reset_chain (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
