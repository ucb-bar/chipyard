...
module TininessRounder(
  ...
  RoundingUnit rounder (	// @[RoundingUnit.scala:46:25]
    .io_in       (io_in_sig[24:2]),	// @[RoundingUnit.scala:47:33, :71:19]
  ...
  assign io_tininess = io_in_sig[26:25] == 2'h0 | io_in_sig[26:25] == 2'h1 & ~_rounder_io_cout;	// @[RoundingUnit.scala:46:25, :77:{32,36,53}, :78:{24,41,44}]
endmodule
