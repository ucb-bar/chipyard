...
class DRAMCacheTopModule(outer: DRAMCacheTop) extends SubsystemModuleImp(outer)
  ...
  with freechips.rocketchip.subsystem.CanHaveMasterAXI4MemPortModuleImp
  with freechips.rocketchip.subsystem.CanHaveMasterAXI4MMIOPortModuleImp
  with freechips.rocketchip.subsystem.CanHaveSlaveAXI4PortModuleImp
