...
module VFMisc(
  ...
  input         io_in_bits_uop_vfpCtrl_isMisc,
  ...
  VFMiscDataModule vfmisc (	// @[VFMisc.scala:187:22]
    .clock                               (clock),
    .reset                               (reset),
    .io_in_valid                         (io_in_valid & io_in_bits_uop_vfpCtrl_isMisc),	// @[VFMisc.scala:191:37]
    ...
    .io_in_bits_uop_vfpCtrl_miscCmd      (io_in_bits_uop_vfpCtrl_miscCmd),
    .io_in_bits_uop_vfpCtrl_miscSubCmd   (io_in_bits_uop_vfpCtrl_miscSubCmd),
