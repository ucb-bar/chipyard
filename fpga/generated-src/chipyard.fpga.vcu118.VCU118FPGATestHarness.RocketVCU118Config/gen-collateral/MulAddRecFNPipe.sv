...
module MulAddRecFNPipe(
  ...
  wire [9:0]  _mulAddRecFNToRaw_postMul_io_rawOut_sExp;	// @[FPU.scala:660:42]
  wire [26:0] _mulAddRecFNToRaw_postMul_io_rawOut_sig;	// @[FPU.scala:660:42]
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddA;	// @[FPU.scala:659:41]
  wire [23:0] _mulAddRecFNToRaw_preMul_io_mulAddB;	// @[FPU.scala:659:41]
  wire [47:0] _mulAddRecFNToRaw_preMul_io_mulAddC;	// @[FPU.scala:659:41]
  ...
  wire [9:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum;	// @[FPU.scala:659:41]
  ...
  wire [4:0]  _mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist;	// @[FPU.scala:659:41]
  wire [25:0] _mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC;	// @[FPU.scala:659:41]
  ...
  always @(posedge clock) begin
    if (io_validin) begin
      ...
      mulAddRecFNToRaw_postMul_io_mulAddResult_b <= {1'h0, {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};	// @[FPU.scala:659:41, :668:45, :669:50, Reg.scala:19:16, Valid.scala:130:22]
  ...
  MulAddRecFNToRaw_preMul mulAddRecFNToRaw_preMul (	// @[FPU.scala:659:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul mulAddRecFNToRaw_postMul (	// @[FPU.scala:660:42]
  ...
  RoundRawFNToRecFN roundRawFNToRecFN (	// @[FPU.scala:687:35]
