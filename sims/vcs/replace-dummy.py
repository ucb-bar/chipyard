...
def main():
  ...
  bash(f"cp {tile_gen_collateral_copy}/*.top.mems.v {subsys_gen_collateral_copy}/")
  bash(f"echo \"/scratch/joonho.whangbo/coding/tile-only-config-chipyard/sims/vcs/generated-src/chipyard.TestHarness.DummyTileConfig-copy/gen-collateral/chipyard.TileOnlyTestHarness.TileOnlyRocketConfig.top.mems.v\" >> {sim_file_common}")
  # TODO : add this to sim_file_common.f
