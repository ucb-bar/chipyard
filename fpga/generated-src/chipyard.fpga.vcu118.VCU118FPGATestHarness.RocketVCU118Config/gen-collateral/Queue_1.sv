...
module Queue_1(
  ...
  ram_combMem_8_VCU118FPGATestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_denied, 1'h0, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
