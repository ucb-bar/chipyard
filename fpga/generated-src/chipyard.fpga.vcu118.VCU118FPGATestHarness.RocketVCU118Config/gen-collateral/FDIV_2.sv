...
module FDIV_2(
  ...
  wire [51:0]  _rounder_io_out;	// @[FDIV.scala:320:23]
  wire         _rounder_io_inexact;	// @[FDIV.scala:320:23]
  wire         _rounder_io_cout;	// @[FDIV.scala:320:23]
  wire [55:0]  _sqrtModule_io_rem;	// @[FDIV.scala:307:26]
  wire [54:0]  _sqrtModule_io_res;	// @[FDIV.scala:307:26]
  wire [54:0]  _sqrtModule_io_resM1;	// @[FDIV.scala:307:26]
  wire [56:0]  _divModule_io_rem;	// @[FDIV.scala:300:25]
  wire [54:0]  _divModule_io_quot;	// @[FDIV.scala:300:25]
  wire [54:0]  _divModule_io_quotM1;	// @[FDIV.scala:300:25]
  wire [5:0]   _dLZC_clz_io_out;	// @[CLZ.scala:23:21]
  wire [5:0]   _aLZC_clz_io_out;	// @[CLZ.scala:23:21]
  ...
  reg  [52:0]  aSigReg;	// @[Reg.scala:19:16]
  reg  [52:0]  dSigReg;	// @[Reg.scala:19:16]
  reg  [11:0]  aExp;	// @[Reg.scala:19:16]
  reg  [11:0]  dExp;	// @[Reg.scala:19:16]
  ...
  reg  [10:0]  special_exp;	// @[Reg.scala:19:16]
  reg  [51:0]  special_sig;	// @[Reg.scala:19:16]
  reg          skipIterReg;	// @[Reg.scala:19:16]
  reg          needShiftReg;	// @[Reg.scala:19:16]
  reg          oddIterReg;	// @[Reg.scala:19:16]
  reg  [4:0]   iterNumReg;	// @[Reg.scala:19:16]
  wire         finalIter = iterNumReg == 5'h0;	// @[FDIV.scala:220:20, :297:27, OneHot.scala:64:12, Reg.scala:19:16]
  wire [57:0]  r = sqrtReg ? {{2{_sqrtModule_io_rem[55]}}, _sqrtModule_io_rem} : {_divModule_io_rem[56], _divModule_io_rem};	// @[Bitwise.scala:77:12, Cat.scala:33:92, FDIV.scala:130:20, :300:25, :307:26, :316:14, Reg.scala:19:16]
  wire [53:0]  _GEN = r[57] ? (sqrtReg ? _sqrtModule_io_resM1[53:0] : _divModule_io_quotM1[53:0]) : sqrtReg ? _sqrtModule_io_res[53:0] : _divModule_io_quot[53:0];	// @[FDIV.scala:300:25, :307:26, :312:18, :313:20, :316:14, :317:{19,26}, Reg.scala:19:16]
  reg  [10:0]  combinedExpReg;	// @[Reg.scala:19:16]
  reg  [51:0]  combinedSigReg;	// @[Reg.scala:19:16]
  ...
  wire [115:0] _aSigNorm_T = {63'h0, aSigReg} << _aLZC_clz_io_out;	// @[CLZ.scala:23:21, FDIV.scala:239:23, Reg.scala:19:16]
  wire [115:0] _dSigNorm_T = {63'h0, dSigReg} << _dLZC_clz_io_out;	// @[CLZ.scala:23:21, FDIV.scala:239:23, :241:23, Reg.scala:19:16]
  wire         decode_a_isSubnormal = ~(|(io_a[62:52])) & (|(io_a[51:0]));	// @[package.scala:36:31, :38:31, :41:27, :45:46, :64:18, :65:18]
  wire         decode_a_isInf = (&(io_a[62:52])) & ~(|(io_a[51:0]));	// @[package.scala:37:31, :38:31, :44:27, :46:40, :64:18, :65:18]
  wire         decode_a_isZero = ~(|(io_a[62:52])) & ~(|(io_a[51:0]));	// @[package.scala:36:31, :38:31, :41:27, :44:27, :47:41, :64:18, :65:18]
  wire         decode_a_isNaN = (&(io_a[62:52])) & (|(io_a[51:0]));	// @[package.scala:37:31, :38:31, :48:40, :64:18, :65:18]
  wire         decode_b_isSubnormal = ~(|(io_b[62:52])) & (|(io_b[51:0]));	// @[package.scala:36:31, :38:31, :41:27, :45:46, :64:18, :65:18]
  wire         decode_b_isInf = (&(io_b[62:52])) & ~(|(io_b[51:0]));	// @[package.scala:37:31, :38:31, :44:27, :46:40, :64:18, :65:18]
  wire         decode_b_isZero = ~(|(io_b[62:52])) & ~(|(io_b[51:0]));	// @[package.scala:36:31, :38:31, :41:27, :44:27, :47:41, :64:18, :65:18]
  ...
  wire [11:0]  _GEN_0 = aExp - 12'h3FF;	// @[FDIV.scala:263:36, Reg.scala:19:16]
  wire [12:0]  finalExp = sqrtReg ? {{2{_GEN_0[11]}}, _GEN_0[11:1]} : {aExp[11], aExp} + ~{dExp[11], dExp} + {12'h0, ~sigCmp};	// @[Bitwise.scala:77:12, Cat.scala:33:92, FDIV.scala:130:20, :259:24, :261:{48,50,78,81}, :263:{36,70}, :264:21, Reg.scala:19:16]
  wire [12:0]  subResBits = finalExp + 13'h434;	// @[FDIV.scala:264:21, :266:27]
  wire [12:0]  _GEN_1 = finalExp + 13'h3FE;	// @[FDIV.scala:264:21, :268:26]
  wire         subRes = _GEN_1[12] & ~(subResBits[12]);	// @[FDIV.scala:266:{27,77}, :268:{26,68,79,82}]
  wire [12:0]  _GEN_2 = ~finalExp + 13'h400;	// @[FDIV.scala:264:21, :267:{17,27}]
  wire         overflow = _GEN_2[12] & ~inv & ~dz & ~inf_div;	// @[FDIV.scala:267:{27,105}, :272:{28,36,40,43}, Reg.scala:19:16]
  wire         underflow_pre = subResBits[12] & ~inv & ~dz & ~zero_div & ~div_inf;	// @[FDIV.scala:266:{27,77}, :272:{28,36}, :273:{49,59,62}, Reg.scala:19:16]
  wire         skipIter = overflow | underflow_pre | inv | dz | subResBits[12] | zero_div | div_inf | inf_div;	// @[FDIV.scala:266:{27,77}, :272:40, :273:59, :282:88, Reg.scala:19:16]
  wire [6:0]   _GEN_3 = subRes ? subResBits[6:0] : 7'h36;	// @[FDIV.scala:266:27, :268:79, :288:26]
  wire [10:0]  resExp = subResReg ? 11'h0 : finalExp[10:0] + 11'h3FF;	// @[Bitwise.scala:77:12, FDIV.scala:264:21, :327:{19,45}, Reg.scala:19:16]
  ...
  wire         decode_a_isSNaN = decode_a_isNaN & ~(io_a[51]);	// @[package.scala:48:40, :49:{37,40,49}]
  wire [5:0]   _GEN_4 = _GEN_3[5:0] - 6'h1;	// @[FDIV.scala:288:26, :294:49]
  always @(posedge clock) begin
    ...
    if (state[0]) begin	// @[FDIV.scala:172:22, :201:99]
      if (io_specialIO_isSqrt)
        resSignReg <= decode_a_isZero & io_a[63];	// @[FDIV.scala:201:43, Reg.scala:19:16, package.scala:47:41, :63:19]
      else
        resSignReg <= io_a[63] ^ io_b[63];	// @[FDIV.scala:201:84, Reg.scala:19:16, package.scala:63:19]
    end
    if (state[0] | state[1]) begin	// @[FDIV.scala:172:22, :229:{73,82,90}]
      if (state[0])	// @[FDIV.scala:172:22, :229:36]
        aSigReg <= {|(io_a[62:52]), io_a[51:0]};	// @[Cat.scala:33:92, Reg.scala:19:16, package.scala:36:31, :64:18, :65:18]
      else	// @[FDIV.scala:229:36]
        aSigReg <= _aSigNorm_T[52:0];	// @[FDIV.scala:239:{12,23}, Reg.scala:19:16]
    end
    if (state[0] | state[1]) begin	// @[FDIV.scala:172:22, :231:{73,82,90}]
      if (state[0])	// @[FDIV.scala:172:22, :231:36]
        dSigReg <= {|(io_b[62:52]), io_b[51:0]};	// @[Cat.scala:33:92, Reg.scala:19:16, package.scala:36:31, :64:18, :65:18]
      else	// @[FDIV.scala:231:36]
        dSigReg <= _dSigNorm_T[52:0];	// @[FDIV.scala:241:{12,23}, Reg.scala:19:16]
    end
    if (state[0] | state[1] & aSubReg) begin	// @[FDIV.scala:172:22, :235:{69,78,87,97}, Reg.scala:19:16]
      if (state[0])	// @[FDIV.scala:172:22, :235:33]
        aExp <= {1'h0, io_a[62:52] | {10'h0, ~(|(io_a[62:52]))}};	// @[FDIV.scala:235:27, Reg.scala:19:16, package.scala:36:31, :64:18, :96:{27,29}]
      else	// @[FDIV.scala:235:33]
        aExp <= aExp - {6'h0, _aLZC_clz_io_out};	// @[CLZ.scala:23:21, FDIV.scala:242:19, Reg.scala:19:16]
    end
    if (state[0] | state[1] & dSubReg) begin	// @[FDIV.scala:172:22, :237:{69,78,87,97}, Reg.scala:19:16]
      if (state[0])	// @[FDIV.scala:172:22, :237:33]
        dExp <= {1'h0, io_b[62:52] | {10'h0, ~(|(io_b[62:52]))}};	// @[FDIV.scala:237:27, Reg.scala:19:16, package.scala:36:31, :64:18, :96:{27,29}]
      else	// @[FDIV.scala:237:33]
        dExp <= dExp - {6'h0, _dLZC_clz_io_out};	// @[CLZ.scala:23:21, FDIV.scala:242:19, :243:19, Reg.scala:19:16]
    end
    if (state[0]) begin	// @[FDIV.scala:172:22, :249:204]
      if (io_specialIO_isSqrt)
        inv <= io_a[63] & ~decode_a_isZero | decode_a_isNaN;	// @[FDIV.scala:249:{46,49,67}, Reg.scala:19:16, package.scala:47:41, :48:40, :63:19]
      else
    ...
    if (state[0]) begin	// @[FDIV.scala:172:22, :250:235]
      if (io_specialIO_isSqrt)
        inv_flag <= io_a[63] & ~(decode_a_isNaN & io_a[51]) & ~decode_a_isZero | decode_a_isSNaN;	// @[FDIV.scala:249:49, :250:{54,70,91}, Reg.scala:19:16, package.scala:47:41, :48:40, :49:{37,49}, :50:37, :63:19]
      else
        inv_flag <= _inv_flag_T_5 | _inv_flag_T_6 | decode_a_isSNaN | decode_b_isNaN & ~(io_b[51]);	// @[FDIV.scala:249:{102,141}, :250:207, Reg.scala:19:16, package.scala:48:40, :49:{37,40,49}]
    end
    ...
    if (state[2])	// @[FDIV.scala:172:22, :278:116]
      special_exp <= {11{inv | overflow | dz | inf_div}};	// @[FDIV.scala:272:40, :278:{34,57}, Reg.scala:19:16]
    if (state[2])	// @[FDIV.scala:172:22, :279:85]
      special_sig <= {inv, 51'h0};	// @[FDIV.scala:279:34, Reg.scala:19:16]
    ...
    if (state[2] | state[3])	// @[FDIV.scala:172:22, :295:{44,54,62}]
      iterNumReg <= state[2] ? (sqrtReg ? _GEN_4[5:1] : _GEN_3[6:2]) : iterNumReg - 5'h1;	// @[FDIV.scala:172:22, :288:26, :294:{24,49,55}, :296:{17,23,58}, Reg.scala:19:16]
    if (state[4]) begin	// @[FDIV.scala:172:22, :346:52]
      if (_combinedSig_T) begin	// @[FDIV.scala:340:31]
        if (noInf)	// @[FDIV.scala:335:98]
          combinedExpReg <= 11'h7FE;	// @[FDIV.scala:338:25, Reg.scala:19:16]
        else	// @[FDIV.scala:335:98]
          combinedExpReg <= 11'h0;	// @[Bitwise.scala:77:12, Reg.scala:19:16]
      end
      else if (skipIterReg)	// @[Reg.scala:19:16]
        combinedExpReg <= special_exp;	// @[Reg.scala:19:16]
      else if (_rounder_io_cout & resExp != 11'h7FE)	// @[FDIV.scala:320:23, :327:19, :338:25, :342:{27,38}]
        combinedExpReg <= resExp + 11'h1;	// @[FDIV.scala:327:19, :342:85, Reg.scala:19:16]
    ...
    if (state[4]) begin	// @[FDIV.scala:172:22, :347:52]
      if (_combinedSig_T) begin	// @[FDIV.scala:340:31]
        if (noInf)	// @[FDIV.scala:335:98]
          combinedSigReg <= 52'hFFFFFFFFFFFFF;	// @[Bitwise.scala:77:12, Reg.scala:19:16]
        else	// @[FDIV.scala:335:98]
          combinedSigReg <= 52'h1;	// @[FDIV.scala:337:25, Reg.scala:19:16]
      end
      else if (skipIterReg)	// @[Reg.scala:19:16]
        combinedSigReg <= special_sig;	// @[Reg.scala:19:16]
      else if (_rounder_io_cout & resExp == 11'h7FE) begin	// @[FDIV.scala:320:23, :327:19, :338:25, :345:{27,38}]
        if (needShiftReg)	// @[Reg.scala:19:16]
          combinedSigReg <= _GEN[53:2];	// @[FDIV.scala:317:19, :321:44, Reg.scala:19:16]
        else	// @[Reg.scala:19:16]
          combinedSigReg <= _GEN[52:1];	// @[FDIV.scala:317:19, :321:66, Reg.scala:19:16]
      end
    ...
    if (state[4]) begin	// @[FDIV.scala:172:22, :348:58]
      if (skipIterReg)	// @[Reg.scala:19:16]
        ...
        combinedFFlagsReg <= {2'h0, &resExp, resExp == 11'h0 & _rounder_io_inexact, _rounder_io_inexact};	// @[Bitwise.scala:77:12, Cat.scala:33:92, FDIV.scala:320:23, :327:19, :329:{20,24}, :330:19, Reg.scala:19:16]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        aSigReg = {_RANDOM_0[31:14], _RANDOM_1, _RANDOM_2[2:0]};	// @[FDIV.scala:172:22, Reg.scala:19:16]
        dSigReg = {_RANDOM_2[31:3], _RANDOM_3[23:0]};	// @[Reg.scala:19:16]
        aExp = {_RANDOM_3[31:24], _RANDOM_4[3:0]};	// @[Reg.scala:19:16]
        dExp = _RANDOM_4[15:4];	// @[Reg.scala:19:16]
        inv = _RANDOM_4[16];	// @[Reg.scala:19:16]
        inv_flag = _RANDOM_4[17];	// @[Reg.scala:19:16]
        dz = _RANDOM_4[18];	// @[Reg.scala:19:16]
        zero_div = _RANDOM_4[19];	// @[Reg.scala:19:16]
        div_inf = _RANDOM_4[20];	// @[Reg.scala:19:16]
        inf_div = _RANDOM_4[21];	// @[Reg.scala:19:16]
        subResReg = _RANDOM_4[22];	// @[Reg.scala:19:16]
        special_fflags = _RANDOM_4[27:23];	// @[Reg.scala:19:16]
        special_exp = {_RANDOM_4[31:29], _RANDOM_5[7:0]};	// @[Reg.scala:19:16]
        special_sig = {_RANDOM_5[31:8], _RANDOM_6[27:0]};	// @[Reg.scala:19:16]
        skipIterReg = _RANDOM_6[28];	// @[Reg.scala:19:16]
        needShiftReg = _RANDOM_7[10];	// @[Reg.scala:19:16]
        oddIterReg = _RANDOM_7[11];	// @[Reg.scala:19:16]
        iterNumReg = _RANDOM_7[16:12];	// @[Reg.scala:19:16]
        combinedExpReg = _RANDOM_7[27:17];	// @[Reg.scala:19:16]
        combinedSigReg = {_RANDOM_7[31:28], _RANDOM_8, _RANDOM_9[15:0]};	// @[Reg.scala:19:16]
        combinedFFlagsReg = _RANDOM_9[20:16];	// @[Reg.scala:19:16]
        combinedSignReg = _RANDOM_9[21];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SqrtIterModule_2 sqrtModule (	// @[FDIV.scala:307:26]
    .clock    (clock),
  ...
  RoundingUnit_2 rounder (	// @[FDIV.scala:320:23]
    .io_in       (needShiftReg ? _GEN[53:2] : _GEN[52:1]),	// @[FDIV.scala:317:19, :321:{23,44,66}, Reg.scala:19:16]
