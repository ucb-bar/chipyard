...
int main(void) {
  ...
  write_spiflash(test_data,
                 ...
                 0x02,
                 3,
                 SPIFLASH_PROTO_SINGLE,
                 SPIFLASH_PROTO_SINGLE);
  if (check_write(test_data, test_len, 0x200))
    return 1;
  ...
  write_spiflash(test_data,
                 ...
                 SPIFLASH_PROTO_SINGLE,
                 SPIFLASH_PROTO_QUAD);
  if (check_write(test_data, test_len, 0x300))
    return 1;
  ...
  write_spiflash(test_data,
                 ...
                 SPIFLASH_PROTO_QUAD,
                 SPIFLASH_PROTO_QUAD);
  if (check_write(test_data, test_len, 0x400))
    return 1;
  ...
  write_spiflash(test_data,
                 ...
                 SPIFLASH_PROTO_SINGLE,
                 SPIFLASH_PROTO_SINGLE);
  if (check_write(test_data, test_len, 0x500))
    return 1;
  ...
  write_spiflash(test_data,
                 ...
                 SPIFLASH_PROTO_SINGLE,
                 SPIFLASH_PROTO_QUAD);
  if (check_write(test_data, test_len, 0x600))
    return 1;
  ...
  write_spiflash(test_data,
                 ...
                 SPIFLASH_PROTO_QUAD,
                 SPIFLASH_PROTO_QUAD);
  if (check_write(test_data, test_len, 0x700))
    return 1;
