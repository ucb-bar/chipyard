...
module ram_combMem_24(	// @[Decoupled.scala:273:95]
  ...
  input          W0_en,
                 W0_clk,
  input  [223:0] W0_data,
  output [223:0] R0_data
);

  reg [223:0] Memory[0:11];	// @[Decoupled.scala:273:95]
    ...
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 12; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[223:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 224'bx;	// @[Decoupled.scala:273:95]
endmodule
