...
if run_step "1"; then
	...
	REQFILE=$CONDA_REQS/base.yaml
    else
	REQFILE=$CONDA_REQS/full.yaml
    fi
    ...
    conda env create -f $REQFILE $CONDA_ENV_ARG
    ...
    # inherited conda functions that would be brought in under a login shell that
