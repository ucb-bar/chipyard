...
module OutTypeClassify(
  ...
  wire decoded_expIsZero = fp_exp == 8'h0;	// @[package.scala:36:31]
  ...
  wire _WIRE_1_10 = decoded_isNaN & ~(fp_sig[22]);	// @[package.scala:48:40, :49:{37,40,49}]
  wire _WIRE_1_9 = decoded_isNaN & fp_sig[22];	// @[package.scala:48:40, :49:49, :50:37]
  wire _WIRE_1_2 = (&(fp_exp[7:2])) & fp_exp[1] & ~(fp_exp[0]);	// @[VFRec.scala:43:{16,31,45,49,52,59}]
  wire _WIRE_1_3 = (&(fp_exp[7:2])) & ~(fp_exp[1]) & fp_exp[0];	// @[VFRec.scala:43:{16,45,59}, :44:{31,39,50}]
  ...
  wire _WIRE_1_4 = _recAbnormalOutputType_T_22 & ~(|(fp_sig[22:21])) & (_recAbnormalOutputType_T_37 | _recAbnormalOutputType_T_46);	// @[VFRec.scala:45:{10,47,51,59,66,74,80}]
  ...
  wire _WIRE_1_5 = _recAbnormalOutputType_T_22 & ~(|(fp_sig[22:21])) & (_recAbnormalOutputType_T_38 | _recAbnormalOutputType_T_47 | _recAbnormalOutputType_T_49);	// @[VFRec.scala:45:{10,47,51}, :46:{51,59,66,80,88,94}]
  wire _WIRE_1_6 = ~fp_sign & decoded_isSubnormal & ~(|(fp_sig[22:21])) & (_recAbnormalOutputType_T_37 | _recAbnormalOutputType_T_38);	// @[VFRec.scala:35:23, :45:{47,51,66}, :46:66, :47:{52,60,75}, package.scala:45:46]
  wire _WIRE_1_7 = ~fp_sign & decoded_isSubnormal & ~(|(fp_sig[22:21])) & (_recAbnormalOutputType_T_46 | _recAbnormalOutputType_T_47 | _recAbnormalOutputType_T_49);	// @[VFRec.scala:35:23, :45:{47,51,80}, :46:{80,94}, :48:{52,60,89}, package.scala:45:46]
