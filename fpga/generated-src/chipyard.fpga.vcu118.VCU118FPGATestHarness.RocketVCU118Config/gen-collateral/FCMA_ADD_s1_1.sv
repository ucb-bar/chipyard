...
module FCMA_ADD_s1_1(
  ...
  wire [10:0]  _near_path_mods_1_io_out_result_exp;	// @[FADD.scala:264:27]
  ...
  wire [106:0] _near_path_mods_1_io_out_sig_raw;	// @[FADD.scala:264:27]
  wire [6:0]   _near_path_mods_1_io_out_lzc;	// @[FADD.scala:264:27]
  wire         _near_path_mods_0_io_out_result_sign;	// @[FADD.scala:264:27]
  wire [10:0]  _near_path_mods_0_io_out_result_exp;	// @[FADD.scala:264:27]
  ...
  wire [106:0] _near_path_mods_0_io_out_sig_raw;	// @[FADD.scala:264:27]
  wire [6:0]   _near_path_mods_0_io_out_lzc;	// @[FADD.scala:264:27]
  wire         decode_a_isInf = (&(io_a[115:105])) & ~(|(io_a[104:0]));	// @[package.scala:37:31, :38:31, :44:27, :46:40, :64:18, :65:18]
  wire         decode_a_isNaN = (&(io_a[115:105])) & (|(io_a[104:0]));	// @[package.scala:37:31, :38:31, :48:40, :64:18, :65:18]
  wire         decode_b_isNaN = (&(io_b[115:105])) & (|(io_b[104:0]));	// @[package.scala:37:31, :38:31, :48:40, :64:18, :65:18]
  wire [10:0]  raw_a_exp = io_a[115:105] | {10'h0, ~(|(io_a[115:105]))};	// @[package.scala:36:31, :64:18, :96:{27,29}]
  wire [105:0] raw_a_sig = {|(io_a[115:105]), io_a[104:0]};	// @[Cat.scala:33:92, package.scala:36:31, :64:18, :65:18]
  wire [10:0]  raw_b_exp = io_b[115:105] | {10'h0, ~(|(io_b[115:105]))};	// @[package.scala:36:31, :64:18, :96:{27,29}]
  wire [105:0] raw_b_sig = {|(io_b[115:105]), io_b[104:0]};	// @[Cat.scala:33:92, package.scala:36:31, :64:18, :65:18]
  wire         eff_sub = io_a[116] ^ io_b[116];	// @[FADD.scala:200:28, package.scala:63:19]
  wire         b_isInf = io_b_inter_valid ? io_b_inter_flags_isInf : (&(io_b[115:105])) & ~(|(io_b[104:0]));	// @[FADD.scala:209:20, package.scala:37:31, :38:31, :44:27, :46:40, :64:18, :65:18]
  ...
  wire [11:0]  exp_diff_a_b = {1'h0, raw_a_exp} - {1'h0, raw_b_exp};	// @[FADD.scala:219:47, package.scala:41:27, :96:27]
  wire [10:0]  _ea_minus_eb_T = raw_b_exp - raw_a_exp;	// @[FADD.scala:220:47, package.scala:96:27]
  wire         need_swap = exp_diff_a_b[11] | io_b_inter_flags_overflow;	// @[FADD.scala:219:47, :222:{36,47}]
  ...
  FarPath_1 far_path_mods_0 (	// @[FADD.scala:240:26]
    .io_in_a_sign       (need_swap ? io_b[116] : io_a[116]),	// @[FADD.scala:222:47, :233:10, package.scala:63:19]
    ...
    .io_in_expDiff      (need_swap ? _ea_minus_eb_T : exp_diff_a_b[10:0]),	// @[FADD.scala:219:47, :220:47, :222:47, :235:10]
  ...
  NearPath_2 near_path_mods_0 (	// @[FADD.scala:264:27]
    .io_in_a_sign       (io_a[116]),	// @[package.scala:63:19]
    .io_in_a_exp        (raw_a_exp),	// @[package.scala:96:27]
    .io_in_a_sig        (raw_a_sig),	// @[Cat.scala:33:92]
    .io_in_b_sign       (io_b[116]),	// @[package.scala:63:19]
  ...
  NearPath_2 near_path_mods_1 (	// @[FADD.scala:264:27]
    .io_in_a_sign       (io_b[116]),	// @[package.scala:63:19]
    .io_in_a_exp        (raw_b_exp),	// @[package.scala:96:27]
    .io_in_a_sig        (raw_b_sig),	// @[Cat.scala:33:92]
    .io_in_b_sign       (io_a[116]),	// @[package.scala:63:19]
  ...
  assign io_out_special_case_bits_iv = decode_a_isNaN & ~(io_a[104]) | (io_b_inter_valid ? io_b_inter_flags_isInv : decode_b_isNaN & ~(io_b[104])) | special_path_inf_iv;	// @[FADD.scala:208:21, :214:55, :217:46, package.scala:48:40, :49:{37,40,49}]
  assign io_out_special_case_bits_nan = special_path_hasNaN | special_path_inf_iv;	// @[FADD.scala:211:44, :214:55, :299:55]
  assign io_out_special_case_bits_inf_sign = decode_a_isInf ? io_a[116] : io_b[116];	// @[FADD.scala:300:43, package.scala:46:40, :63:19]
  assign io_out_small_add = ~(|(io_a[115:105])) & ~(|(io_b[115:105]));	// @[FADD.scala:202:38, package.scala:36:31, :41:27, :64:18]
  assign io_out_far_path_mul_of = io_b_inter_flags_overflow | (&(io_b[115:105])) & ~eff_sub;	// @[FADD.scala:200:28, :225:22, :284:{46,69}, package.scala:37:31, :64:18]
  ...
  assign io_out_sel_far_path = ~eff_sub | (|(need_swap ? _ea_minus_eb_T[10:1] : exp_diff_a_b[10:1])) | io_b_inter_flags_overflow;	// @[FADD.scala:200:28, :219:47, :220:47, :222:47, :224:{24,75}, :225:{22,46,52}]
endmodule
