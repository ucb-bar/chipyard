...
module FarPath(
  ...
  wire [49:0] _shiftRightJam_io_out;	// @[ShiftRightJam.scala:28:31]
  wire        _shiftRightJam_io_sticky;	// @[ShiftRightJam.scala:28:31]
  ShiftRightJam shiftRightJam (	// @[ShiftRightJam.scala:28:31]
  ...
  assign io_out_sig_b = (io_in_effSub ? {1'h1, ~_shiftRightJam_io_out, ~_shiftRightJam_io_sticky} : {1'h0, _shiftRightJam_io_out, _shiftRightJam_io_sticky}) + {51'h0, io_in_effSub};	// @[Cat.scala:33:92, FADD.scala:36:{27,37,88}, ShiftRightJam.scala:28:31]
  assign io_out_exp_a_vec_0 = io_in_a_exp + 8'h1;	// @[FADD.scala:46:28]
  assign io_out_exp_a_vec_1 = io_in_a_exp;
  assign io_out_exp_a_vec_2 = io_in_a_exp - 8'h1;	// @[FADD.scala:47:29]
endmodule
