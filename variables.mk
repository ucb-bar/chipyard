...
export JAVA_TOOL_OPTIONS ?= -Xmx$(JAVA_HEAP_SIZE) -Xss8M
...
export SBT_OPTS ?= -Dsbt.global.base=$(base_dir)/.sbt -Dsbt.color=always -Dsbt.supershell=false -Dsbt.server.forcestart=true
SBT ?= sbt $(SBT_OPTS)
