...
module TLXbar(
  ...
  assign auto_in_d_bits_sink = (muxStateEarly_0 ? {2'h0, auto_out_0_d_bits_sink} : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_sink : 3'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:310:24, :326:28]
