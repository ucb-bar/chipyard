...
module Queue_77(
  ...
  wire [31:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_address_combMem ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_data_tag = _ram_ext_R0_data[31:17];	// @[Decoupled.scala:273:95]
endmodule
