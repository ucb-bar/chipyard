...
module SqrtIterModule_2(
  ...
  wire [55:0]     _csa_iter_io_out_0;	// @[FDIV.scala:600:23]
  wire [55:0]     _csa_iter_io_out_1;	// @[FDIV.scala:600:23]
  ...
  reg  [54:0]     aReg;	// @[Reg.scala:19:16]
  reg  [54:0]     bReg;	// @[Reg.scala:19:16]
  reg  [2:0]      aHeadReg;	// @[FDIV.scala:539:21]
  reg  [55:0]     wsReg;	// @[Reg.scala:19:16]
  reg  [55:0]     wcReg;	// @[Reg.scala:19:16]
  ...
  wire [54:0]     _f_T_7 = ~aReg;	// @[FDIV.scala:596:6, Reg.scala:19:16]
  wire [120:0]    _csa_iter_io_in_2_T_2 = {9'h0, (s_sel_q_0 ? {bReg[53:0], 4'hC} : 58'h0) | (s_sel_q_1 ? {bReg, 3'h7} : 58'h0) | (s_sel_q_3 ? {_f_T_7, 3'h7} : 58'h0) | (s_sel_q_4 ? {_f_T_7[53:0], 4'hC} : 58'h0), 54'h0} >> {88'h0, jReg, 1'h0};	// @[FDIV.scala:593:{11,16}, :594:11, :596:{6,12}, :597:12, :603:{26,40}, :638:40, :639:42, :641:42, :642:44, Mux.scala:27:73, :81:61, Reg.scala:19:16]
  wire            s_sel_q_2 = _GEN_3[7] & ~(_GEN_2[7]);	// @[FDIV.scala:589:{20,49}, :640:{27,30}]
  wire [54:0]     _GEN_5 = {aReg[52:0], 2'h1};	// @[FDIV.scala:650:21, :651:26, Reg.scala:19:16]
  wire [54:0]     _GEN_6 = {aReg[52:0], 2'h0};	// @[Cat.scala:33:92, FDIV.scala:650:21, Reg.scala:19:16]
  wire [54:0]     _GEN_7 = {bReg[52:0], 2'h3};	// @[Cat.scala:33:92, FDIV.scala:653:23, Reg.scala:19:16]
  wire [54:0]     _GEN_8 = {bReg[52:0], 2'h2};	// @[FDIV.scala:650:26, :653:23, Reg.scala:19:16]
  wire [54:0]     aIter = (s_sel_q_4 ? {aReg[52:0], 2'h2} : 55'h0) | (s_sel_q_3 ? _GEN_5 : 55'h0) | (s_sel_q_2 ? _GEN_6 : 55'h0) | (s_sel_q_1 ? _GEN_7 : 55'h0) | (s_sel_q_0 ? _GEN_8 : 55'h0);	// @[FDIV.scala:538:27, :638:40, :639:42, :640:27, :641:42, :642:44, :650:{21,26}, :653:23, Mux.scala:27:73, Reg.scala:19:16]
  wire [54:0]     _aHeadReg_T_9 = aIter >> {22'h0, jReg - 32'h2, 1'h0};	// @[FDIV.scala:624:24, :628:{13,20}, Mux.scala:27:73, Reg.scala:19:16]
  wire [54:0]     _aHeadReg_T_1 = aIter >> {22'h0, jReg, 1'h0};	// @[FDIV.scala:624:24, Mux.scala:27:73, Reg.scala:19:16]
  always @(posedge clock) begin
    if (|io_state) begin	// @[FDIV.scala:537:74]
      if (io_state[0])	// @[FDIV.scala:537:33]
        aReg <= 55'h1;	// @[FDIV.scala:537:27, Reg.scala:19:16]
      else	// @[FDIV.scala:537:33]
        aReg <= aIter;	// @[Mux.scala:27:73, Reg.scala:19:16]
    end
    if (|io_state) begin	// @[FDIV.scala:538:74]
      if (io_state[0])	// @[FDIV.scala:537:33]
        bReg <= 55'h0;	// @[FDIV.scala:538:27, Reg.scala:19:16]
      else	// @[FDIV.scala:537:33]
        bReg <= (s_sel_q_4 ? _GEN_5 : 55'h0) | (s_sel_q_3 ? _GEN_6 : 55'h0) | (s_sel_q_2 ? _GEN_7 : 55'h0) | (s_sel_q_1 ? _GEN_8 : 55'h0) | (s_sel_q_0 ? {bReg[52:0], 2'h1} : 55'h0);	// @[FDIV.scala:538:27, :638:40, :639:42, :640:27, :641:42, :642:44, :650:21, :651:26, :653:23, Mux.scala:27:73, Reg.scala:19:16]
    end
    ...
    if (|io_state) begin	// @[FDIV.scala:542:77]
      if (io_state[0])	// @[FDIV.scala:537:33]
        wcReg <= 56'h0;	// @[FDIV.scala:542:28, Reg.scala:19:16]
      else	// @[FDIV.scala:537:33]
        wcReg <= {_csa_iter_io_out_1[54:0], 1'h0};	// @[FDIV.scala:600:23, :605:{30,41}, Reg.scala:19:16]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_7 = `RANDOM;
        _RANDOM_8 = `RANDOM;
        aReg = {_RANDOM_0, _RANDOM_1[22:0]};	// @[Reg.scala:19:16]
        bReg = {_RANDOM_1[31:23], _RANDOM_2, _RANDOM_3[13:0]};	// @[Reg.scala:19:16]
        aHeadReg = _RANDOM_3[16:14];	// @[FDIV.scala:539:21, Reg.scala:19:16]
        wsReg = {_RANDOM_3[31:17], _RANDOM_4, _RANDOM_5[8:0]};	// @[Reg.scala:19:16]
        wcReg = {_RANDOM_5[31:9], _RANDOM_6, _RANDOM_7[0]};	// @[Reg.scala:19:16]
        jReg = {_RANDOM_7[31:1], _RANDOM_8[0]};	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  CSA3_2_62 signs_csa_sel_0 (	// @[FDIV.scala:570:21]
    .io_in_0  (wsReg[55:48]),	// @[FDIV.scala:571:31, Reg.scala:19:16]
    .io_in_1  (wcReg[55:48]),	// @[FDIV.scala:572:31, Reg.scala:19:16]
  ...
  CSA3_2_138 csa_iter (	// @[FDIV.scala:600:23]
    .io_in_0  ({wsReg[53:0], 2'h0}),	// @[Cat.scala:33:92, FDIV.scala:601:20, Reg.scala:19:16]
    .io_in_1  ({wcReg[53:0], 2'h0}),	// @[Cat.scala:33:92, FDIV.scala:602:20, Reg.scala:19:16]
    .io_in_2  (_csa_iter_io_in_2_T_2[55:0]),	// @[FDIV.scala:603:{20,40}]
