...
module Queue_84(
  input         clock,
                reset,
                io_enq_valid,
  input  [31:0] io_enq_bits_v_inst,
  input  [63:0] io_enq_bits_v_rs1,
                io_enq_bits_v_rs2,
  ...
  assign io_deq_bits_v_rs2 = _ram_ext_R0_data[159:96];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_v_fp_rs1 = _ram_ext_R0_data[223:160];	// @[Decoupled.scala:273:95]
