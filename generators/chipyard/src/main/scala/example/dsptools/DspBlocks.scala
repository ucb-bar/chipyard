...
/** The memory interface writes entries into the queue. They stream out the streaming interface
  * @param depth
  *   number of entries in the queue
  * @param streamParameters
  *   parameters for the stream node
  * @param p
  */
...
/** TLDspBlock specialization of WriteQueue
  ...
  *   number of entries in the queue
  * @param csrAddress
  *   address range for peripheral
  * @param beatBytes
  *   beatBytes of TL interface
  * @param p
  */
class TLWriteQueue(depth: Int, csrAddress: AddressSet, beatBytes: Int)(implicit p: Parameters)
    extends WriteQueue[
...
/** The streaming interface adds elements into the queue. The memory interface can read elements out of the queue.
  * @param depth
  *   number of entries in the queue
  * @param streamParameters
  *   parameters for the stream node
...
/** TLDspBlock specialization of ReadQueue
  ...
  * @param p
  */
class TLReadQueue(depth: Int, csrAddress: AddressSet, beatBytes: Int)(implicit p: Parameters)
    extends ReadQueue[
      TLClientPortParameters,
      TLManagerPortParameters,
      TLEdgeOut,
