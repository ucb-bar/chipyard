...
class BeagleTop(implicit p: Parameters) extends example.BoomAndRocketSubsystem
...
class BeagleTopModule[+L <: BeagleTop](l: L) extends example.BoomAndRocketSubsystemModuleImp(l)
