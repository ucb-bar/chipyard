...
module FPUFMAPipe_1(
  ...
  wire [64:0] _fma_io_out;	// @[FPU.scala:723:19]
  wire [4:0]  _fma_io_exceptionFlags;	// @[FPU.scala:723:19]
  wire        _fma_io_validout;	// @[FPU.scala:723:19]
  ...
  always @(posedge clock) begin
    ...
    if (io_in_valid) begin
      ...
      if (io_in_bits_swap23)
        in_in2 <= 65'h8000000000000000;	// @[FPU.scala:712:15, :719:32]
      else
      ...
      if (io_in_bits_ren3 | io_in_bits_swap23)	// @[FPU.scala:720:21]
        ...
        in_in3 <= (io_in_bits_in1 ^ io_in_bits_in2) & 65'h10000000000000000;	// @[FPU.scala:712:15, :715:{32,50,57}]
    end
    if (_fma_io_validout) begin	// @[FPU.scala:723:19]
      io_out_b_data <= ({65{_fma_io_out[63:61] != 3'h7}} | 65'h1EFEFFFFFFFFFFFFF) & _fma_io_out;	// @[FPU.scala:256:{25,56}, :420:27, :421:10, :723:19, Reg.scala:19:16]
      io_out_b_exc <= _fma_io_exceptionFlags;	// @[FPU.scala:723:19, Reg.scala:19:16]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  MulAddRecFNPipe_1 fma (	// @[FPU.scala:723:19]
    .clock             (clock),
    .reset             (reset),
    .io_validin        (valid),	// @[FPU.scala:711:22]
    .io_op             (in_fmaCmd),	// @[FPU.scala:712:15]
    .io_a              (in_in1),	// @[FPU.scala:712:15]
    .io_b              (in_in2),	// @[FPU.scala:712:15]
    .io_c              (in_in3),	// @[FPU.scala:712:15]
