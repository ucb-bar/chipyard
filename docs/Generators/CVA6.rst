...
The `CVA6 core` is `wrapped <https://github.com/ucb-bar/cva6-wrapper>`__ in a `CVA6 tile` so it can be used as a component within the `Rocket Chip SoC generator`.
