...
module VFRec(
  ...
  input         io_in_bits_uop_vfpCtrl_isRec7,
                io_in_bits_uop_vfpCtrl_isRecSqrt7,
  ...
  VFRecDataModule vfrec (	// @[VFRec.scala:10:21]
    .clock                               (clock),
    .reset                               (reset),
    .io_in_valid                         (io_in_valid & (io_in_bits_uop_vfpCtrl_isRec7 | io_in_bits_uop_vfpCtrl_isRecSqrt7)),	// @[VFRec.scala:17:{36,55}]
    ...
    .io_in_bits_uop_vfpCtrl_isRec7       (io_in_bits_uop_vfpCtrl_isRec7),
