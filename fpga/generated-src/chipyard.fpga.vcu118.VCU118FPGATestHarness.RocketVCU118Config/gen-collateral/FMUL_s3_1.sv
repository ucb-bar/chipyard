...
module FMUL_s3_1(
  ...
  wire        common_of = (_rounder_io_cout ? io_in_raw_out_exp[10:0] == 11'h7FE : (&(io_in_raw_out_exp[10:0]))) | io_in_early_overflow;	// @[FMUL.scala:184:14, :202:22, :204:16, :205:16, :206:5, RoundingUnit.scala:46:25]
  ...
  TininessRounder_1 tininess_rounder (	// @[FMUL.scala:187:32]
    .io_in_sign  (io_in_raw_out_sign),
    .io_in_sig   ({io_in_raw_out_sig[160:106], |(io_in_raw_out_sig[105:0])}),	// @[Cat.scala:33:92, FMUL.scala:185:{37,70,86}]
    .io_rm       (io_in_rm),
    .io_tininess (_tininess_rounder_io_tininess)
  );
  RoundingUnit_2 rounder (	// @[RoundingUnit.scala:46:25]
    .io_in       (io_in_raw_out_sig[159:108]),	// @[FMUL.scala:193:20, RoundingUnit.scala:47:33]
    .io_roundIn  (io_in_raw_out_sig[107]),	// @[FMUL.scala:193:20, RoundingUnit.scala:48:{38,50}]
    .io_stickyIn (|{io_in_raw_out_sig[106], |(io_in_raw_out_sig[105:0])}),	// @[FMUL.scala:185:{70,86}, :193:20, RoundingUnit.scala:49:{39,54}]
  ...
  assign io_result = io_in_special_case_valid ? (io_in_special_case_bits_nan ? 64'h7FF8000000000000 : {io_in_raw_out_sign, io_in_special_case_bits_inf ? 63'h7FF0000000000000 : 63'h0}) : {io_in_raw_out_sign, common_of ? {10'h3FF, ~rmin} : {10'h0, _rounder_io_cout} + io_in_raw_out_exp[10:0], common_of ? {52{rmin}} : _rounder_io_out};	// @[Cat.scala:33:92, FMUL.scala:184:14, :199:37, :206:5, :212:19, :216:23, :221:23, :223:8, :232:27, :234:8, :244:19, RoundingUnit.scala:46:25, :58:41]
  ...
  assign io_to_fadd_fp_prod_exp = io_in_special_case_bits_hasZero ? 11'h0 : io_in_raw_out_exp[10:0];	// @[FMUL.scala:248:32]
  assign io_to_fadd_fp_prod_sig = io_in_special_case_bits_hasZero ? 105'h0 : io_in_raw_out_sig[159:55] | {104'h0, |(io_in_raw_out_sig[54:0])};	// @[FMUL.scala:249:32, :251:{21,29,49,67,86}]
  ...
  assign io_to_fadd_inter_flags_overflow = io_in_raw_out_exp[11];	// @[FMUL.scala:256:52]
endmodule
