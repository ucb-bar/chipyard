...
module ram_s_v_pc_combMem(	// @[Decoupled.scala:273:95]
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [3:0]  W0_addr,
  ...
  reg [39:0] Memory[0:11];	// @[Decoupled.scala:273:95]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 40'bx;	// @[Decoupled.scala:273:95]
endmodule
