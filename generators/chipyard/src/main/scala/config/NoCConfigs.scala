...
class MultiNoCConfig
    extends Config(
      new constellation.soc.WithCbusNoC(
        constellation.protocol.TLNoCParams(
          constellation.protocol.DiplomaticNetworkNodeMapping(
            inNodeMapping   = ListMap("serial-tl" -> 0),
          ...
          constellation.protocol.TLNoCParams(
            constellation.protocol.DiplomaticNetworkNodeMapping(
              inNodeMapping   = ListMap(
                "L2 InclusiveCache[0]" -> 1,
                "L2 InclusiveCache[1]" -> 2,
                "L2 InclusiveCache[2]" -> 5,
                "L2 InclusiveCache[3]" -> 6,
              ),
              outNodeMapping  =
                ListMap("system[0]" -> 0, "system[1]" -> 3, "system[2]" -> 4, "system[3]" -> 7, "serdesser" -> 0),
            ),
            NoCParams(
              topology        = TerminalRouter(BidirectionalTorus1D(8)),
              channelParamGen = (a, b) => UserChannelParams(Seq.fill(10) { UserVirtualChannelParams(4) }),
              routingRelation =
                BlockingVirtualSubnetworksRouting(TerminalRouterRouting(BidirectionalTorus1DShortestRouting()), 5, 2),
            ),
          )
        ) ++
        new constellation.soc.WithSbusNoC(
          constellation.protocol.TLNoCParams(
            constellation.protocol.DiplomaticNetworkNodeMapping(
              ...
              outNodeMapping  =
                ListMap("system[0]" -> 5, "system[1]" -> 6, "system[2]" -> 9, "system[3]" -> 10, "pbus" -> 3),
            ),
            NoCParams(
    ...
    extends Config(
      new constellation.soc.WithGlobalNoC(
          ...
          NoCParams(
            topology        = TerminalRouter(
              HierarchicalTopology(
                ...
                children = Seq(
                  HierarchicalSubTopology(1, 2, BidirectionalLine(5)),
        ...
        new constellation.soc.WithMbusNoC(
          constellation.protocol.TLNoCParams(
            constellation.protocol.DiplomaticNetworkNodeMapping(
              inNodeMapping  = ListMap("Cache[0]" -> 0, "Cache[1]" -> 2, "Cache[2]" -> 8, "Cache[3]" -> 6),
              outNodeMapping = ListMap("system[0]" -> 3, "system[1]" -> 5, "serdesser" -> 9),
            )
          ),
          true,
        ) ++
        new constellation.soc.WithSbusNoC(
          constellation.protocol.TLNoCParams(
            constellation.protocol.DiplomaticNetworkNodeMapping(
              ...
              outNodeMapping =
                ListMap("system[0]" -> 0, "system[1]" -> 2, "system[2]" -> 8, "system[3]" -> 6, "pbus" -> 4),
            )
          ),
          true,
        ) ++
      ...
      new constellation.soc.WithSbusNoC(
        constellation.protocol.TLNoCParams(
          constellation.protocol.DiplomaticNetworkNodeMapping(
            ...
            outNodeMapping  =
              ListMap("system[0]" -> 9, "system[1]" -> 10, "system[2]" -> 11, "system[3]" -> 12, "pbus" -> 8),
